...
public class WebTableUtilities {
	 ...
	 * @param webTableObjectOne - Test Object for WebTable 1 referred by OR
	 * @param webTableObjectTwo - Test Object for WebTable 2 referred by OR
	 */
	...
	public static List<String> readWebTableData(TestObject webTableObject) {
		...
		try {
			...
			for (WebElement row : rows) {
				...
				List<WebElement> cells = row.findElements(By.tagName("th")); // Get both headers and cells in one go
